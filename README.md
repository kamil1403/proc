<p align="center">
  <img src="https://github.com/kamil1403/proc/blob/main/screenshots/proc.jpg" alt="Banner" width="65%">
</p>
...
### ✅ Результат:   
- [x] Результат ДЗ - рабочий скрипт который можно запустить. Результат см. на скриншоте 🖼️ ["log_report_tg"](https://github.com/kamil1403/otus_bash/blob/main/screenshots/log_report_tg.png)     
