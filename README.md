...
### ✅ Результат:   
- [x] Результат ДЗ - рабочий скрипт который можно запустить. Результат см. на скриншоте 🖼️ ["my_ps.sh"](https://github.com/kamil1403/otus_bash/blob/main/screenshots/log_report_tg.png](https://github.com/kamil1403/proc/blob/main/screenshots/my_ps.sh.png)     
